...
if uploaded_file:
   ...
   llm = ChatOpenAI(model="arcee-ai/trinity-large-preview:free", api_key=st.secrets["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"]) # CORRECT
